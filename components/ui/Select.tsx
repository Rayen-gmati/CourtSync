    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ref={ref}
            className={`w-full px-4 py-2.5 pr-10 bg-[var(--bg-inset)] border border-transparent rounded-input text-[var(--text-main)] outline-none transition-all focus:border-[var(--accent-cta)] focus:ring-2 focus:ring-[var(--accent-cta)]/25 disabled:opacity-50 disabled:bg-[var(--bg-dim)] appearance-none cursor-pointer active:opacity-90 ${
